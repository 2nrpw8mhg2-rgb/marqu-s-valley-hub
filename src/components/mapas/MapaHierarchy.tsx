...
function GrupoTitulo({ id, nivel, nome, total, resumo, aberto, descricaoExpandida, onGrupo, onDescricao }: { id: string; nivel: 1 | 2; nome: string; total: number; resumo: string | null; aberto: boolean; descricaoExpandida: boolean; onGrupo: () => void; onDescricao: () => void }) {
